...
export class Cheque33Component implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.subscription = this.ajouterFichierService.fichiers$.subscribe(data => {
      console.log('🔍 DEBUG Cheque33 - Tous les fichiers reçus:', data);
      ...
      this.fichiers = (data || []).filter(f => {
        ...
        // Accepte UNIQUEMENT le code 33
        const isValidCode = code === '33';
        ...
        if (match) {
          console.log('✅ Fichier correspond aux critères cheque33');
        }
        
        return match;
      });
      
      console.log('📊 Fichiers filtrés pour cheque33:', this.fichiers);
      this.applyFilters();
